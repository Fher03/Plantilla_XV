<template>
  <div
    class="flex flex-col items-center gap-15 h-fit w-screen xl:w-100 py-10 px-5"
  >
    <!-- Title -->
    <div
      class="text-center font-great-vibes flex flex-col gap-2 text-primary-dark"
    >
      <h2 class="text-5xl">Código de vestimenta</h2>
      <h3 class="text-3xl">Formal</h3>
    </div>
    <div class="flex justify-center gap-10">
      <img src="/icons/smokin_icon.svg" class="w-40" >
    ...
    <div class="flex justify-center gap-10">
      <img src="/icons/mail_icon.svg" class="w-25" >
      <img src="/icons/gift_icon.svg" class="w-25" >
    </div>
  </div>
</template>
